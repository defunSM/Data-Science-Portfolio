# -*- coding: utf-8 -*-
#
# Eve Online PI Price Forcaster documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'Eve Online PI Price Forcaster'
...
htmlhelp_basename = 'eve_online_pi_price_forcasterdoc'
...
latex_documents = [
    ('index',
     'eve_online_pi_price_forcaster.tex',
     u'Eve Online PI Price Forcaster Documentation',
     u"Salman Hossain", 'manual'),
]
